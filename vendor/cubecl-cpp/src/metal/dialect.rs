...
impl DialectTypes<Self> for MslDialect {
    ...
    /// Metal supports native vector types: float2, float3, float4, half2, half4, etc.
    /// These enable hardware-accelerated vectorized math (e.g. air.fast_exp.v4f32).
    fn supports_native_vec() -> bool {
        true
    }
